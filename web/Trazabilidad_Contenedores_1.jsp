                            ...
                            <%                            String usuario = String.valueOf(session.getAttribute("usuario"));
                                ...
                                for (int i = 0; i < lista.size(); i++) {
                                    ...
                                    if (lista.get(i).getC5() != null) {
                                        ...
                                        out.println("<td class='text-center'> <img src='img/bullet-red.png' class=' tooltipped ' data-position='bottom' data-tooltip='Sin Datos'></></td>");

                                    }

                                    if (lista.get(i).getC6().equals("NO")) {
                                        out.println("<td class='text-center'> <img src='img/bullet-red.png' class=' tooltipped ' data-position='bottom' data-tooltip='Sin Datos'></a></td>");
                                    } else {
                                        out.println("<td class='text-center'> <img src='img/bullet-green.png' class=' tooltipped ' data-position='bottom' data-tooltip='" + lista.get(i).getC6() + "'></a></td>");
