...
public final class Detalle_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                <table id=\"ejemplo\" border=\"1\"   class=\"highlight responsive-table striped \" >\n");
      out.write("                    <thead class=\"encabezado\">\n");
      out.write("                        <tr>\n");
      out.write("\n");
      out.write("                            <th>CORRELATIVO</th>\n");
      out.write("                            <th>CANTIDAD</th>                           \n");
      out.write("                            <th>CODIGO TARIFA</th>                            \n");
      out.write("                            <th>VALOR</th>\n");
      out.write("                            <th>SUB TOTAL</th>\n");
      out.write("                            <th>DESCUENTO</th>\n");
      out.write("                            <th>DESCRIPCION</th>\n");
      out.write("                            <th>VALOR QUETZAL</th>\n");
      out.write("                            <th>FACTOR AJUSTE</th>\n");
      out.write("                            <th>UNIDAD MEDIDA</th>\n");
      out.write("\n");
      out.write("\n");
      out.write("                        </tr>\n");
      out.write("                    </thead>\n");
      ...
      out.write("        {\n");
      out.write("            //Defino los totales de mis 2 columnas en 0\n");
      out.write("            \n");
      out.write("            var total_col5 = 0;\n");
      out.write("            //Recorro todos los tr ubicados en el tbody\n");
      out.write("            $('#ejemplo tbody').find('tr').each(function (i, el) {\n");
      out.write("\n");
      out.write("                //Voy incrementando las variables segun la fila ( .eq(0) representa la fila 1 )     \n");
      out.write("                    total_col5 += parseFloat($(this).find('td').eq(4).text());\n");
      out.write("\n");
      out.write("            });\n");
      out.write("            //Muestro el resultado en el th correspondiente a la columna\n");
      out.write("              $('#ejemplo tfoot tr th').eq(9).text(\"Total \" + total_col5);\n");
      out.write("\n");
      out.write("        });\n");
      out.write("    </script>\n");
      out.write("\n");
