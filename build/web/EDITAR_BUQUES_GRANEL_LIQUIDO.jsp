...
<html>
    ...
    <head>
        ...
        <body>
            ...
            <form action="ServleLiquido.do" method="post" >
                ...
                <table class="responsive-table highlight striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input  placeholder="Toneladas" name="CWSL_DESC_GAS_PROPANO" type="text" class="validate">
                                <label for="CWSL_DESC_GAS_PROPANO"></label>
                            </td>

                            <td>
                                <input  placeholder="Toneladas" name="CWSL_CARGA_GAS_PROPANO" type="text" class="validate">
