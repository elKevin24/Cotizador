...
<html>
    ...
    <head>
        ...
        <%
            ...
            BeanSolido solido = new BeanSolido();
            solido = Detalle_S.Obtenerxedit(Cotizacion);

            String eta = solido.getCWBC_ETA();
        ...
        <body>
            ...
            <form action="ACTUALIZAR_BUQUE_GRANEL_SOLIDO.jsp" method="post" >
                <div class="divider"></div>
                <div class="section">
                    <div class="row">
                        <div class="input-field col s5">
                            <input placeholder="" type="number" id="CWBC_HORA" name="CWBC_HORA" class="validate" value="<%= solido.getCWBC_HORA()%>">
                    ...
                    <tbody >
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input  placeholder="Toneladas" name="CWSL_DESC_ACEITE_GRASA_QUIMI" type="number" class="validate" value="<%=solido.getCWSL_DESC_ACEITE_GRASA_QUIMI()%>">
                                <label for="CWSL_DESC_ACEITE_GRASA_QUIMI"></label>

                            </td>

                            <td>
                                <input  placeholder="Toneladas" name="CWSL_CARGA_ACEITE_GRASA_QUIMI" type="number" class="validate" value="<%=solido.getCWSL_CARGA_ACEITE_GRASA_QUIMI()%>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input  placeholder="Toneladas" name="CWSL_DESC_COMBUSTIBLES_DERIV" type="number" class="validate" value="<%=solido.getCWSL_DESC_COMBUSTIBLES_DERIV()%>">
                                <label for="CWSL_DESC_COMBUSTIBLES_DERIV"></label>
                            </td>

                            <td>
                                <input  placeholder="Toneladas" name="CWSL_CARGA_COMBUSTIBLES_DERIV" type="number" class="validate" value="<%=solido.getCWSL_CARGA_COMBUSTIBLES_DERIV()%>">
