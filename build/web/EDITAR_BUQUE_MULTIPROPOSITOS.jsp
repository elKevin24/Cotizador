...
<html>
    ...
    <head>
        ...
        <%
            ...
            BeanMulti multi = new BeanMulti();
            multi = Detalle_M.Obtenerxedit(Cotizacion);
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="ACTUALIZAR_BUQUE_MULTIPROPOSITOS.jsp" method="post" >
                <div >
                    ...
                    <table id="1" class="table table-bordered table-sm ">
                        ...
                        <table id="1" class="table table-bordered table-sm ">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input  placeholder="Movimientos" name="CWSF_REEMBARQUE_LLENO_RF_GP" type="number" class="validate" value="<%= multi.getCWSM_REEMBARQUE_LLENO_RF_GP()%>">
                                ...
                                <td>
                                    <input  placeholder="Movimientos" name="CWSF_REEMBARQUE_LLENO_RF_GB" type="number" class="validate" value="<%= multi.getCWSM_REEMBARQUE_LLENO_RF_GB()%>"> 
                            ...
                            <table id="1" class="table table-bordered table-sm ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input  placeholder="Movimientos" name="CWSF_DESCARGA_MERCA_GP_VI" type="number" class="validate" value="<%= multi.getCWSF_DESCARGA_MERCA_GP_VI()%>">
                                        <label for="CWSF_DESCARGA_MERCA_GP_VI"></label>
                                    </td>

                                    <td>
                                        <input  placeholder="Movimientos" name="CWSM_DESCARGA_MERCA_GP_VI_HR" type="number" class="validate" value="<%= multi.getCWSM_DESCARGA_MERCA_GP_VI_HR()%>">
                                        <label for="CWSM_DESCARGA_MERCA_GP_VI_HR"></label>
                                    </td>
                                    ...
                                    <td>
                                        <input  placeholder="Movimientos" name="CWSM_DESCARGA_MERCA_GP_VD_HR" type="number" class="validate" value="<%= multi.getCWSM_DESCARGA_MERCA_GP_VD_HR()%>">
                                        <label for="CWSM_DESCARGA_MERCA_GP_VD_HR"></label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input  placeholder="Horas" name="CWSM_CARGA_MERCA_GP_VI_HR" type="number" class="validate" value="<%= multi.getCWSM_CARGA_MERCA_GP_VI_HR()%>">
                                        <label for="CWSM_CARGA_MERCA_GP_VI_HR"></label>
                                    </td>
                                    ...
                                    <td>
                                        <input  placeholder="Horas" name="CWSM_CARGA_MERCA_GP_VD_HR" type="number" class="validate" value="<%= multi.getCWSM_CARGA_MERCA_GP_VD_HR()%>">
                                        <label for="CWSM_CARGA_MERCA_GP_VD_HR"></label>
                                    </td>
